...
{
    public class DelegationOfPowerHistoryService : IGenericAdminModuleRepository
    {
        private readonly IEntityRepository<OtpTab> _entityRepository;
        public DelegationOfPowerHistoryService(IEntityRepository<OtpTab> entityRepository)
        {
