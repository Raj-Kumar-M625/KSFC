...
namespace KAR.KSFC.API.ServiceFacade.Internal.Service.IDMModule
{
    public class IdmService : IIdmService
    {
        ...
        public IdmService(IEntityRepository<TblAppLoanMast> loanRepository, IEntityRepository<TblEmpchairDet> empChairDet, IEntityRepository<TblIdmLegalWorkflow> legalWokFlow)
        {
        ...
        public async Task<IEnumerable<LoanAccountNumberDTO>> GetAccountNumber(string EmpId , CancellationToken token)
        {
