...
ALTER TABLE [dbo].[Image] DROP CONSTRAINT [DF__Image__OrderSour__4C8B54C9]
GO
ALTER TABLE [dbo].[Image] DROP CONSTRAINT [DF__Image__PaymentSo__6E01572D]
GO
