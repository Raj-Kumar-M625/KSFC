...
ADD
	[AppliedTransactionType] NVARCHAR(50) NOT NULL DEFAULT '',
	[AppliedItemMasterId] BIGINT NULL REFERENCES dbo.ItemMaster,
...
SET AppliedTransactionType = TransactionType,
AppliedItemMasterId = ItemMasterId,
AppliedQuantity = Quantity,
AppliedItemRate = ItemRate
GO

ALTER TABLE dbo.IssueReturn
ALTER COLUMN [AppliedItemMasterId] BIGINT NOT NULL
GO
