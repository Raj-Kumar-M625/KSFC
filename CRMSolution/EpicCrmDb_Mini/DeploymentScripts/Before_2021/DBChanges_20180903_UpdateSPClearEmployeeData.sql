...
BEGIN
	BEGIN TRY
		...
		DELETE FROM dbo.[SqliteEntityContact] WHERE [SqliteEntityId] IN (@SqliteEntity)
		DELETE FROM dbo.[SqliteEntityCrop] WHERE [SqliteEntityId] IN (@SqliteEntity)
		...
		DELETE FROM dbo.[EntityContact] WHERE [EntityId] IN (@Entity)
		DELETE FROM dbo.[EntityCrop] WHERE [EntityId] IN (@Entity)
