...
ADD	[LocalFileName] NVARCHAR(512) NOT NULL DEFAULT '',
...
-- truncate excel upload status and error tables.
Truncate table dbo.ExcelUploadError
GO
DELETE FROM dbo.ExcelUploadStatus
GO

-- Added reitzel tables in clean up script
