...
Add [PhoneDbId] NVARCHAR(50) NOT NULL DEFAULT ''
go

ALTER TABLE [dbo].[SqliteReturnOrder]
ADD [PhoneDbId] NVARCHAR(50) NOT NULL DEFAULT '',
[PhoneActivityId] NVARCHAR(50) NOT NULL DEFAULT ''
go

ALTER TABLE dbo.SqlitePayment
ADD [PhoneDbId] NVARCHAR(50) NOT NULL DEFAULT '',
[PhoneActivityId] NVARCHAR(50) NOT NULL DEFAULT ''
GO
...
Add [ActivityType] NVARCHAR(50) NOT NULL DEFAULT ''
go
...
FROM dbo.Tracking T
INNER JOIN dbo.Activity A on t.ActivityId = A.Id
AND t.ActivityId > 0
GO
...
ALTER TABLE [dbo].[Image] DROP CONSTRAINT [DF__Image__OrderSour__1352D76D]
GO
ALTER TABLE [dbo].[Image] DROP CONSTRAINT [DF__Image__PaymentSo__74AE54BC]
GO
...
-- Add Tracking Data sproc 
-- Deployment Notes Item 28
ALTER PROCEDURE [dbo].[AddTrackingData]
	@employeeDayId BIGINT,
	@trackingDateTime DateTime2,
	@latitude Decimal(19,9),
...
/* Feb 13 2019
Following index could not be created due to duplicates
CREATE Unique INDEX [IX_Customer_CustomerCode]
	ON [dbo].[Customer]
	(CustomerCode)
go

select customerCode, count(*) from dbo.Customer
group by CustomerCode
having count(*) > 1

select * from dbo.Customer where CustomerCode in ('MP3800080', 'TN3700005')
