Alter table SqliteAgreement
Add TerritoryCode nvarchar(10) null,
TerritoryName nvarchar(50) null,
HQCode nvarchar(10) null,
HQName nvarchar(50) null
GO
--Rename the existing Stroed Procedure   as "ProcessSqlliteAgreementDataOld2"

Exec
  sp_rename  'dbo.ProcessSqliteAgreementDataOld' ,   'ProcessSqliteAgreementDataOld2'
  Go
--Added new SP --
