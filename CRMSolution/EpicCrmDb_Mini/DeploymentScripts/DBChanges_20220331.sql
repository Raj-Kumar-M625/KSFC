ALTER TABLE [dbo].[SqliteDayPlanTarget]
	ADD [TargetDemoActivity] INT NOT NULL DEFAULT 0
GO
...
ALTER PROCEDURE [dbo].[ProcessSqliteDayPlanTargetData]
	@batchId BIGINT
AS
BEGIN
	-- Kartik June 04 2021
...
values
('DayPlanType', 'Demonstration', 'Demonstration', 40, 1, 1)
GO