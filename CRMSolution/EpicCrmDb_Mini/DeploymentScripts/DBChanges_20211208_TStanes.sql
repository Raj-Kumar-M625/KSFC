--- TStanes Specific Change - As we don't have direct HQ mapping for PPA, therefore, for PPA, system should allow employee upload files without HQ Code also
...
ALTER PROCEDURE [dbo].[TransformPPAStaffData]
	@tenantId BIGINT,
