--Added 8 new columns into Agreement Table   Date: 20230114--
Alter table EntityAgreement 
Add ZoneCode nvarchar(10) ,
...
Go
--Author:Swetha M, Purpose: AgreementsReport on: 2023/01/15
ALTER TABLE [dbo].[FeatureControl]
ADD [AgreementsReport] BIT NOT NULL DEFAULT 0
GO
--Rename the Existing SP--
Exec
  sp_rename  'dbo.ProcessSqliteAgreementData' ,   'ProcessSqliteAgreementDataOld'
  Go

/****** Object: Creaed new  StoredProcedure [dbo].[ProcessSqliteAgreementData]    Script Date: 14-01-2023 20:26:11 ******/
...
BEGIN
	...
	Declare @EntityOffice  TABLE (EntityId BIGINT, ZoneCode NVARCHAR(10) , ZoneName nvarchar(50) ,AreaCode nvarchar(10) ,
	...
	(EntityId,ZoneCode,ZoneName,AreaCode,AreaName,TerritoryCode,TerritoryName,HQCode,HQName )  
	SELECT Distinct(et.Id) As EntityId, oh.ZoneCode, ct.CodeName AS ZoneName,
		...
		Inner JOIN Entity  et on et.HQCode=oh.HQCode
		Inner JOIN  SqliteAgreement  sag on sag.EntityId=et.Id
	...
	INNER JOIN @EntityOffice eo on ag.EntityId=eo.EntityId 
