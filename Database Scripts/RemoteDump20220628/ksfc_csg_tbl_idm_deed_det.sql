...
--
-- Table structure for table `tbl_idm_deed_det`
--

DROP TABLE IF EXISTS `tbl_idm_deed_det`;
...
--
-- Dumping data for table `tbl_idm_deed_det`
--

LOCK TABLES `tbl_idm_deed_det` WRITE;
/*!40000 ALTER TABLE `tbl_idm_deed_det` DISABLE KEYS */;
INSERT INTO `tbl_idm_deed_det` VALUES (1,98765432101,1,11,1,'3211','New_Test_Case ',100000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_idm_deed_det` ENABLE KEYS */;
UNLOCK TABLES;
