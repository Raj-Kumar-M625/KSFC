...
--
-- Table structure for table `tbl_pjcost_cdtab`
--

DROP TABLE IF EXISTS `tbl_pjcost_cdtab`;
...
--
-- Dumping data for table `tbl_pjcost_cdtab`
--

LOCK TABLES `tbl_pjcost_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_pjcost_cdtab` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tbl_pjcost_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:19:00
