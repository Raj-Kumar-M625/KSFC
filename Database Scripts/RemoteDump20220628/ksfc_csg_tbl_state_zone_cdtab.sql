...
--
-- Table structure for table `tbl_state_zone_cdtab`
--

DROP TABLE IF EXISTS `tbl_state_zone_cdtab`;
...
--
-- Dumping data for table `tbl_state_zone_cdtab`
--

LOCK TABLES `tbl_state_zone_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_state_zone_cdtab` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tbl_state_zone_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:20:03
