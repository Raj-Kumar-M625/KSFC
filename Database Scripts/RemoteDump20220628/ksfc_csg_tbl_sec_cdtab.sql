...
--
-- Table structure for table `tbl_sec_cdtab`
--

DROP TABLE IF EXISTS `tbl_sec_cdtab`;
...
--
-- Dumping data for table `tbl_sec_cdtab`
--

LOCK TABLES `tbl_sec_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_sec_cdtab` DISABLE KEYS */;
INSERT INTO `tbl_sec_cdtab` VALUES (1,'Security Details 1',1,_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL),(2,'Security Details 2',1,_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_sec_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:17:53
