...
--
-- Table structure for table `tbl_pjsec_cdtab`
--

DROP TABLE IF EXISTS `tbl_pjsec_cdtab`;
...
--
-- Dumping data for table `tbl_pjsec_cdtab`
--

LOCK TABLES `tbl_pjsec_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_pjsec_cdtab` DISABLE KEYS */;
INSERT INTO `tbl_pjsec_cdtab` VALUES (1,'Security Type 1',1,_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL),(2,'Security Type 2',1,_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_pjsec_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
