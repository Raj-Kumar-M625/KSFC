...
--
-- Table structure for table `tbl_pjcostgroup_cdtab`
--

DROP TABLE IF EXISTS `tbl_pjcostgroup_cdtab`;
...
--
-- Dumping data for table `tbl_pjcostgroup_cdtab`
--

LOCK TABLES `tbl_pjcostgroup_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_pjcostgroup_cdtab` DISABLE KEYS */;
INSERT INTO `tbl_pjcostgroup_cdtab` VALUES (1,'test',_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_pjcostgroup_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:17:42
