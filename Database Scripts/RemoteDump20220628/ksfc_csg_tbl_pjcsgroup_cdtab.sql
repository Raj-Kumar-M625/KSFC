...
--
-- Table structure for table `tbl_pjcsgroup_cdtab`
--

DROP TABLE IF EXISTS `tbl_pjcsgroup_cdtab`;
...
--
-- Dumping data for table `tbl_pjcsgroup_cdtab`
--

LOCK TABLES `tbl_pjcsgroup_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_pjcsgroup_cdtab` DISABLE KEYS */;
INSERT INTO `tbl_pjcsgroup_cdtab` VALUES (1,'tes',1,_binary '',_binary '\0',NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_pjcsgroup_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:18:40
