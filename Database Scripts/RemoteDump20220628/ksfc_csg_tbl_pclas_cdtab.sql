...
--
-- Table structure for table `tbl_pclas_cdtab`
--

DROP TABLE IF EXISTS `tbl_pclas_cdtab`;
...
--
-- Dumping data for table `tbl_pclas_cdtab`
--

LOCK TABLES `tbl_pclas_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_pclas_cdtab` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_pclas_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:18:26
