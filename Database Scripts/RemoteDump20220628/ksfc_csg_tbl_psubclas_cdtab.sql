...
--
-- Table structure for table `tbl_psubclas_cdtab`
--

DROP TABLE IF EXISTS `tbl_psubclas_cdtab`;
...
--
-- Dumping data for table `tbl_psubclas_cdtab`
--

LOCK TABLES `tbl_psubclas_cdtab` WRITE;
/*!40000 ALTER TABLE `tbl_psubclas_cdtab` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_psubclas_cdtab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:19:37
