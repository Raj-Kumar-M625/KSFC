...
--
-- Dumping data for table `tbl_unit_mast`
--

LOCK TABLES `tbl_unit_mast` WRITE;
/*!40000 ALTER TABLE `tbl_unit_mast` DISABLE KEYS */;
INSERT INTO `tbl_unit_mast` VALUES (1,1,'TEST_Case',11,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tbl_unit_mast` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-28 19:19:15
