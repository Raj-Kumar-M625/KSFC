...
namespace KAR.KSFC.UI.Areas.Admin.Controllers.IDM.UnitDetails.AssetDetails
{
    ...
    public class IndigenousMachineryAdController : Controller
    {
        private readonly ILogger _logger;
        private readonly SessionManager _sessionManager;

        public IndigenousMachineryAdController(ILogger logger, SessionManager sessionManager)
        {
            _logger = logger;
        ...
        public IActionResult Create(long accountNumber, long InspectionId, byte OffcCd, string LoanSub, bool firstinspection)
        {
            try
            {
                ...
                return View(Constants.IndigenousresultViewPathAd + Constants.createCS);
            }
        ...
        public IActionResult Create(IdmDchgIndigenousInspectionDTO indigenousMachineryInspection)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return Json(new { isValid = true, data = list.LoanAcc, html = Helper.RenderRazorViewToString(this, Constants.IndigenousviewPathAd + Constants.ViewAll, indigenousMachineryInspectionDetails) });
                }
                return Json(new { isValid = false, html = Helper.RenderRazorViewToString(this, Constants.IndigenousviewPathAd + Constants.Create, indigenousMachineryInspection) });
            }
            catch (System.Exception ex)
            {
        ...
        public IActionResult ViewRecord(string id = "")
        {
            try
            {
                ...
                return View(Constants.IndigenousresultViewPathAd + Constants.ViewRecord, indigenousMachineryInspectionList);
        ...
        public IActionResult Edit(long InspectionId, int row, string id = "")
        {
            try
            {
                ...
                _logger.Information(CommonLogHelpers.ViewRecordCompleted + id);
                return View(Constants.IndigenousresultViewPathAd + Constants.editCs, indigenousMachineryInspectionList);
        ...
        public IActionResult Edit(string id, IdmDchgIndigenousInspectionDTO indigenousMachineryInspection)
        {
            try
            {
                ...
                return Json(new { isValid = false, html = Helper.RenderRazorViewToString(this, Constants.IndigenousviewPathAd + Constants.Edit, indigenousMachineryInspection) });
            }
            catch (System.Exception ex)
            {
        ...
        public IActionResult Delete(long InspectionId, string id)
        {
            try
            {
                ...
                return Json(new { isValid = true, html = Helper.RenderRazorViewToString(this, Constants.IndigenousviewPathAd + Constants.ViewAll, activeIndigenousMach),delete = "Canceled" });
