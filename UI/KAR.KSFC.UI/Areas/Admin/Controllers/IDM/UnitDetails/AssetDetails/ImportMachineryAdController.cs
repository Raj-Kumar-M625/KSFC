...
namespace KAR.KSFC.UI.Areas.Admin.Controllers.IDM.UnitDetails.AssetDetails
{
    ...
    public class ImportMachineryAdController : Controller
    {
        private readonly ILogger _logger;
        private readonly SessionManager _sessionManager;


        public ImportMachineryAdController(ILogger logger, SessionManager sessionManager)
        {
        ...
        public IActionResult Create(long accountNumber, long InspectionId, byte OffcCd, string LoanSub, bool firstinspection)
        {
            ...
            try
            {
                ...
                return View(Constants.ImportresultViewPathAd + Constants.createCS);
        ...
        public IActionResult Create(IdmDchgImportMachineryDTO model)
        {
            ...
            try
            {
                ...
                return Json(new { isValid = true, data = list.LoanAcc, html = Helper.RenderRazorViewToString(this, Constants.ImportviewPathAd + Constants.ViewAll, importMachineryList) });
                //}
        ...
        public IActionResult ViewRecord(string id = "")
        {
            try
            {
                ...
                return View(Constants.ImportresultViewPathAd + Constants.ViewRecord, importMachineryList);
        ...
        public IActionResult Edit(long InspectionId, int row, string id = "")
        {
            try
            {
                ...
                return View(Constants.ImportresultViewPathAd + Constants.editCs, importMachinery);
        ...
        public IActionResult Delete(long InspectionId, string id)
        {
            try
            {
                ...
                return Json(new { isValid = true, html = Helper.RenderRazorViewToString(this, Constants.ImportviewPathAd + Constants.ViewAll, activeImportMachinery),delete = "Canceled" });
