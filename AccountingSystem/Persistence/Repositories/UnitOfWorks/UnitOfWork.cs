...
namespace Persistence.Repositories.UnitOfWorks
{
        ...
        public void Save()
        {
            try
            {
                ...
                foreach (var validationErrors in dbEx.EntityValidationErrors)
                {
                    ...
                    {
                        errorMessageBuilder.AppendFormat("Property: {0} Error: {1}{2}",
                            validationError.PropertyName, validationError.ErrorMessage, Environment.NewLine);
                    }
                }

                throw new Exception(errorMessageBuilder.ToString(), dbEx);
