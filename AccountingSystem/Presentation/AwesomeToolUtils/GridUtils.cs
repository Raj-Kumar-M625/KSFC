...
namespace Presentation.Utils
{
    public static class GridUtils
    {
        ...
        public static string DeleteFormat(string popupName,string key = "Id",string deleteContent = null,string btnClass = null,bool nofocus = false)
        {
            ...
            return string.Format("<button aria-label=\"delete\" type=\"button\" class=\"awe-btn awe-nonselect delbtn {3}\" {4} onclick=\"awe.open('{0}', {{ params:{{ id: '.({1})' }} }}, event)\">{2}</button>",
        ...
        public const string EditGridNestFormat = "<button type='button' class='awe-btn editnst'><span class='ico-crud ico-edit'></span></button>";
        ...
        //}
        public const string DeleteGridNestFormat = "<button type='button' class='awe-btn delnst'><span class='ico-crud ico-del'></span></button>";
        ...
        //}
        public const string AddChildFormat = "<button type='button' class='awe-btn awe-nonselect o-pad' onclick=\"awe.open('createNode', { params:{ parentId: '.(Id)' } })\">add child</button>";
        ...
        //}
        public const string MoveBtn = "<button type=\"button\" class=\"awe-movebtn awe-btn\" tabindex=\"-1\"><i class=\"awe-icon\"></i></button>";
